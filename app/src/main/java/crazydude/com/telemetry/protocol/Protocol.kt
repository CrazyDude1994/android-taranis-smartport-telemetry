...
abstract class Protocol(val dataDecoder: DataDecoder) {
    ...
    companion object {
        ...
        const val DATA_ID_ACC_X = 38
        const val DATA_ID_ACC_Y = 39
        const val DATA_ID_ACC_Z = 40
        const val GPS_STATE_ARDU = 41
        //ardupilot S.PORT passthrough  Data ID's
        const val RxBt = 42
        const val ARDU_TEXT = 43
        const val ARDU_ATTITUDE = 44
        const val ARDU_VEL_YAW = 45
        const val ARDU_AP_STATUS = 46
        const val ARDU_GPS_STATUS = 47
        const val ARDU_HOME = 48
        const val ARDU_BATT_2 = 49
